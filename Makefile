...
BDIR?=sam9x60ek sama5d29_curiosity sama5d27_som1_ek sama5d27_wlsom1_ek sama5d2_icp sama5d2_ptc_ek sama5d2_xplained sama5d2_xplained_grts sama5d3_xplained sama5d3_eds sama5d4_xplained sama7d65_curiosity sama7d65_curiosity_pro sama7d65_curiosity_joemdiente sama7g5ek sama7g54_curiosity sam9x60_curiosity sam9x75eb mpfs_icicle mpfs_icicle_amp mpfs_video pic64gx_curiosity_kit
...
MPFS_ICICLE_AMP_DTBO_OBJECTS:= $(patsubst %.dtso,%.dtbo,$(wildcard mpfs_icicle/*.dtso))
...
RTPFS_DEV_KIT_DTBO_OBJECTS:= $(patsubst %.dtso,%.dtbo,$(wildcard rtpfs_dev_kit/*.dtso))
...
SAM9X60_CURIOSITY_PRO_DTBO_OBJECTS:= $(patsubst %.dtso,%.dtbo,$(wildcard sam9x60_curiosity_pro/*.dtso))
...
SAMA7D65_CURIOSITY_PRO_DTBO_OBJECTS:= $(patsubst %.dtso,%.dtbo,$(wildcard sama7d65_curiosity_pro/*.dtso))
...
SAMA7D65_CURIOSITY_JOEMDIENTE_DTBO_OBJECTS:=$(patsubst %.dtso,%.dtbo,$(wildcard sama7d65_curiosity_joemdiente/*.dtso))
...
rtpfs_dev_kit_dtbos: $(RTPFS_DEV_KIT_DTBO_OBJECTS)

sam9x60ek_dtbos: $(SAM9X60EK_DTBO_OBJECTS)

sam9x60_curiosity_dtbos: $(SAM9X60_CURIOSITY_DTBO_OBJECTS)

sam9x60_curiosity_pro_dtbos: $(SAM9X60_CURIOSITY_PRO_DTBO_OBJECTS)
...
sama7d65_curiosity_pro_dtbos: $(SAMA7D65_CURIOSITY_PRO_DTBO_OBJECTS)

sama7g5ek_dtbos: $(SAMA7G5EK_DTBO_OBJECTS)

sama7g54_curiosity_dtbos: $(SAMA7G54_CURIOSITY_DTBO_OBJECTS)

sama7d65_curiosity_joemdiente_dtbos: $(SAMA7D65_CURIOSITY_JOEMDIENTE_DTBO_OBJECTS)
